Shader "Unlit/blinn-phongShader"
{
    Properties
    {
        //Property는 아래 형식을 따름
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct Interpolators
            {
                ...
                float2 uv : TEXCOORD1; 
                float3 positionWC : TEXCOORD2; //World Position
            };
            ...
            float4 frag (Interpolators i) : SV_TARGET 
            {
                ...
                Light secondLight = GetAdditionalLight(0,i.positionWC);
                ...
                float3 V = normalize(GetCameraPositionWS() - i.positionWC);
                ...
                float3 ambient = kd*ia; //ambient Formula
                float3 diffuse = kd*id*dotLN; //Diffuse Formula
